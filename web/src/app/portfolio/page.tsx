...
import { ArrowLeft, ShieldAlert, Layers, Network, LogOut, Loader2, Printer } from "lucide-react";
import { LogoLockup } from "@/components/animated-logo";
import { ThemeToggle } from "@/components/theme-toggle";
import { RiskDial, Stat } from "@/components/ui";
...
export default function Portfolio() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-5 pb-20">
      ...
      <p className="mt-4 text-center text-[11px] text-muted">Portfolio shown on a demo book of vendors with representative distributions; onboarded vendors fold in as they complete assessments. Threat mapping is deterministic (control gaps → threats), not live threat intel.</p>
    </main>
  );
}
